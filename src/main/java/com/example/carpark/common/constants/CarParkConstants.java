...
public final class CarParkConstants {
    ...
    public static final String AVAILABLE_ENDPOINT = "/available";
    public static final String IMPORT_ENDPOINT = "/import";
    public static final String UPDATE_AVAILABILITY_ENDPOINT =
        "/update-availability";
    ...
    // Cache Configuration
    public static final String CACHE_NEAREST_CAR_PARKS = "nearestCarParks";
    public static final String CACHE_ALL_CAR_PARKS = "allCarParks";
    public static final int CACHE_TTL_MINUTES = 15;

    // Error Messages
    public static final String ERROR_INVALID_COORDINATES =
        "Invalid coordinates provided";
    public static final String ERROR_INVALID_PAGE_PARAMETERS =
        "Invalid page parameters";
    public static final String ERROR_EXTERNAL_API_FAILED =
        "External API call failed";
    public static final String ERROR_DATABASE_OPERATION_FAILED =
        "Database operation failed";
    public static final String ERROR_CSV_IMPORT_FAILED = "CSV import failed";
    public static final String ERROR_AVAILABILITY_UPDATE_FAILED =
        "Availability update failed";

    // Success Messages
    public static final String SUCCESS_IMPORT_COMPLETED =
        "Car park data streaming import completed successfully";
    public static final String SUCCESS_AVAILABILITY_UPDATED =
        "Car park availability update completed successfully";
    public static final String SUCCESS_HEALTH_CHECK = "Car Park API is running";

    // Validation Messages
    public static final String VALIDATION_LATITUDE_RANGE =
        "Latitude must be between -90 and 90";
    public static final String VALIDATION_LONGITUDE_RANGE =
        "Longitude must be between -180 and 180";
    public static final String VALIDATION_PAGE_SIZE_RANGE =
        "Page size must be between 1 and " + MAX_PAGE_SIZE;
    public static final String VALIDATION_SEARCH_RADIUS_RANGE =
        "Search radius must be between 0.1 and " + MAX_SEARCH_RADIUS_KM + " km";
}
